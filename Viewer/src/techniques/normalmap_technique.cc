...
void NormalMapTechnique::SetLightComponent(QOpenGLShaderProgram &shader, std::string const &type,
                       Light const &light) {
...
void NormalMapTechnique::SetAttenuationComponent(QOpenGLShaderProgram &shader,
